...
A(3,2,4:6) = 3; %from thalamus to pareital at 4-6 lags (alpha freq)

%residual cov matrix
SIGT = eye(nvar);

%simulate TS
nobs = 10000; %number of observation(timepoints), here assume 1000
ntrials = 1; %number of trials, here assume 100
